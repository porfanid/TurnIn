...
export const checkMac = (event) => {
  if (!confirm("This has not been tested yet. Are you sure that you want to download it?")) {
...
- <a
  href="https://github.com/porfanid/TurnIn/releases/download/3.0.0/turnin.dmg"
  onClick={checkMac}
>
  TurnIn for Mac
</a>
